 ...
 * <ul>
 *   <li>{@link org.xtext.editor.yang.yang.DescriptionStatement#getDescription <em>Description</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.DescriptionStatement#getDescriptionunknownstatements <em>Descriptionunknownstatements</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.editor.yang.yang.YangPackage#getDescriptionStatement()
 * @model
 * @generated
 */
public interface DescriptionStatement extends ModuleStatement, SubmoduleStatement, MultipleSubstatement, RpcSubstatement, NotificationSubstatement, ContainerSubstatement, ListSubstatement, GroupingSubstatement, LeafSubstatement, LeafListSubstatement, ChoiceSubstatement, CaseSubstatement, AnyxmlSubstatement, UsesSubstatement, AugmentSubstatement, RefineSubstatement, DeviationSubstatement, ExtensionSubstatement, IdentitySubstatement, FeatureSubstatement, TypedefSubstatement, BitSubstatement, EnumSubstatement, WhenSubstatements, RevisionSubstatements
{
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getDescriptionStatement_Description()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.DescriptionStatement#getDescription <em>Description</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getDescriptionStatement_Descriptionunknownstatements()
