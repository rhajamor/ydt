 ...
 * <ul>
 *   <li>{@link org.xtext.editor.yang.yang.AugmentUsesStatement#getArg <em>Arg</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.AugmentUsesStatement#getAugmentsubstatements <em>Augmentsubstatements</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.editor.yang.yang.YangPackage#getAugmentUsesStatement()
 * @model
 * @generated
 */
public interface AugmentUsesStatement extends UsesSubstatement
{
   ...
   * @see #setArg(String)
   * @see org.xtext.editor.yang.yang.YangPackage#getAugmentUsesStatement_Arg()
   * @model
   * @generated
   */
  String getArg();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.AugmentUsesStatement#getArg <em>Arg</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getAugmentUsesStatement_Augmentsubstatements()
