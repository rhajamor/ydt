 ...
 * <ul>
 *   <li>{@link org.xtext.editor.yang.yang.BuiltInType#getBtype <em>Btype</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.editor.yang.yang.YangPackage#getBuiltInType()
 * @model
 * @generated
 */
public interface BuiltInType extends EObject
{
   ...
   * @see #setBtype(String)
   * @see org.xtext.editor.yang.yang.YangPackage#getBuiltInType_Btype()
   * @model
   * @generated
   */
  String getBtype();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.BuiltInType#getBtype <em>Btype</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
