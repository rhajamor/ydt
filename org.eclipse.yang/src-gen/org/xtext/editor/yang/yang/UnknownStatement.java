 ...
 * <ul>
 *   <li>{@link org.xtext.editor.yang.yang.UnknownStatement#getPref <em>Pref</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.UnknownStatement#getNamestat <em>Namestat</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.UnknownStatement#getArgument <em>Argument</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.UnknownStatement#getUnknownsubstatements <em>Unknownsubstatements</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.editor.yang.yang.YangPackage#getUnknownStatement()
 * @model
 * @generated
 */
public interface UnknownStatement extends ModuleStatement, SubmoduleStatement, MultipleSubstatement, RpcSubstatement, InputSubstatement, OutputSubstatement, NotificationSubstatement, ContainerSubstatement, ListSubstatement, GroupingSubstatement, LeafSubstatement, LeafListSubstatement, ChoiceSubstatement, CaseSubstatement, AnyxmlSubstatement, UsesSubstatement, AugmentSubstatement, RefineSubstatement, DeviationSubstatement, DeviateSubstatement, ExtensionSubstatement, ArgumentSubstatement, IdentitySubstatement, FeatureSubstatement, BelongsToSubstatement, TypedefSubstatement, TypeSubStatement, BitSubstatement, EnumSubstatement, ImportSubstatements, IncludeSubstatements, WhenSubstatements, RevisionSubstatements
{
   ...
   * @see #setPref(String)
   * @see org.xtext.editor.yang.yang.YangPackage#getUnknownStatement_Pref()
   * @model
   * @generated
   */
  String getPref();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.UnknownStatement#getPref <em>Pref</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getUnknownStatement_Namestat()
   * @model
   * @generated
   */
  String getNamestat();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.UnknownStatement#getNamestat <em>Namestat</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getUnknownStatement_Argument()
   * @model
   * @generated
   */
  String getArgument();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.UnknownStatement#getArgument <em>Argument</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getUnknownStatement_Unknownsubstatements()
