 ...
 * <ul>
 *   <li>{@link org.xtext.editor.yang.yang.IfFeatureStatement#getPref <em>Pref</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.IfFeatureStatement#getIdent <em>Ident</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.IfFeatureStatement#getIffeatureunknownstatements <em>Iffeatureunknownstatements</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.editor.yang.yang.YangPackage#getIfFeatureStatement()
 * @model
 * @generated
 */
public interface IfFeatureStatement extends RpcSubstatement, NotificationSubstatement, ContainerSubstatement, ListSubstatement, LeafSubstatement, LeafListSubstatement, ChoiceSubstatement, CaseSubstatement, AnyxmlSubstatement, UsesSubstatement, AugmentSubstatement, FeatureSubstatement
{
   ...
   * @see #setPref(String)
   * @see org.xtext.editor.yang.yang.YangPackage#getIfFeatureStatement_Pref()
   * @model
   * @generated
   */
  String getPref();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.IfFeatureStatement#getPref <em>Pref</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getIfFeatureStatement_Ident()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.IfFeatureStatement#getIdent <em>Ident</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getIfFeatureStatement_Iffeatureunknownstatements()
