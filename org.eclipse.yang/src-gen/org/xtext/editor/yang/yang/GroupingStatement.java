 ...
 * <ul>
 *   <li>{@link org.xtext.editor.yang.yang.GroupingStatement#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.editor.yang.yang.GroupingStatement#getGroupingsubstatements <em>Groupingsubstatements</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.editor.yang.yang.YangPackage#getGroupingStatement()
 * @model
 * @generated
 */
public interface GroupingStatement extends ModuleStatement, SubmoduleStatement, RpcSubstatement, InputSubstatement, OutputSubstatement, NotificationSubstatement, ContainerSubstatement, ListSubstatement, GroupingSubstatement
{
   ...
   * @see #setName(String)
   * @see org.xtext.editor.yang.yang.YangPackage#getGroupingStatement_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.editor.yang.yang.GroupingStatement#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link org.xtext.editor.yang.yang.GroupingSubstatement}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see org.xtext.editor.yang.yang.YangPackage#getGroupingStatement_Groupingsubstatements()
