...
* generated by Xtext
*/
package org.xtext.editor.yang.ui.contentassist.antlr;
...
public class YangParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.editor.yang.ui.contentassist.antlr.internal.InternalYangParser createParser() {
		org.xtext.editor.yang.ui.contentassist.antlr.internal.InternalYangParser result = new org.xtext.editor.yang.ui.contentassist.antlr.internal.InternalYangParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBaseStatementAccess().getAlternatives_3(), "rule__BaseStatement__Alternatives_3");
					...
					put(grammarAccess.getBaseStatementAccess().getGroup_1(), "rule__BaseStatement__Group_1__0");
					put(grammarAccess.getBaseStatementAccess().getGroup_3_1(), "rule__BaseStatement__Group_3_1__0");
					...
					put(grammarAccess.getBaseStatementAccess().getPrefAssignment_1_0(), "rule__BaseStatement__PrefAssignment_1_0");
					put(grammarAccess.getBaseStatementAccess().getIdentAssignment_2(), "rule__BaseStatement__IdentAssignment_2");
					put(grammarAccess.getBaseStatementAccess().getBaseunknownstatementsAssignment_3_1_1(), "rule__BaseStatement__BaseunknownstatementsAssignment_3_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.editor.yang.ui.contentassist.antlr.internal.InternalYangParser typedParser = (org.xtext.editor.yang.ui.contentassist.antlr.internal.InternalYangParser) parser;
